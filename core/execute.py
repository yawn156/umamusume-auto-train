...
def do_recreation():
  click("assets/buttons/recreation_btn.png")
...
def race_day():
  click("assets/buttons/race_day_btn.png", minSearch=10)

  click(img="assets/ui/match_track.png", minSearch=1)
...
def race_select():
  ...
  for i in range(10):
    match_race = pyautogui.locateCenterOnScreen("assets/ui/match_track.png", confidence=0.8, minSearchTime=1)
    if match_race:
      print("[INFO] Race found.")
      pyautogui.moveTo(match_race, duration=0.2)
      pyautogui.click(match_race)
